...
export type Config = { theme: ThemeMode, agent_market_api_key: string | null, disclaimer_acknowledged: boolean, onboarding_acknowledged: boolean, telemetry_acknowledged: boolean, sound_alerts: boolean, sound_file: SoundFile, push_notifications: boolean, editor: EditorConfig, github: GitHubConfig, analytics_enabled: boolean | null, };
...
export type CreateTask = { project_id: string, title: string, description: string | null, max_reward: number, };

export type CreateTaskAndStart = { project_id: string, title: string, description: string | null, max_reward: number, };
